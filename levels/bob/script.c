...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_TOAD2, 3617, 102, 12, 0, 180, 0, 0x00020000, bhvToad2),
		OBJECT(MODEL_TOAD2, 797, 102, 6740, 0, 180, 0, 0x00070000, bhvToad2),
		OBJECT(MODEL_TOAD2, -1140, 102, -7028, 0, 180, 0, 0x00080000, bhvToad2),
