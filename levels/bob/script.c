...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_BOWSER_BOMB, 831, 102, -5459, 0, 0, 0, 0x00000000, bhvBowserBomb),
		...
		OBJECT(MODEL_BITS_WARP_PIPE , 3714, 102, 4493, 0, 0, 0, 0x00030000, bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE , 3396, 102, 4534, 0, 0, 0, 0x00040000, bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE , 3064, 102, 4498, 0, 0, 0, 0x00050000, bhvWarpPipe),
