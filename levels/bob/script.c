...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(0xFF, -1990, 102, -497, 0, 0, 0, 0x00000000, bhvToadMessage),
		OBJECT(MODEL_FLYGUY, -1529, 102, -275, 0, 0, 0, 0x00000000, bhvFlyGuy),
		...
		OBJECT(MODEL_BULLY, -1852, 102, 171, 0, 0, 0, 0x00000000, bhvSmallBully),
