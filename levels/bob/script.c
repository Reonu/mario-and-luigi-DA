...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		WARP_NODE(0x0B, LEVEL_CCM, 0x08, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_LUIGINPC, 1859, 311, 6831, 0, 180, 0, 0x00010000, bhvLuigiNpc),
		...
		OBJECT(MODEL_TOAD2, -56, 102, 2234, 0, 180, 0, 0x00000000, bhvToad2),
		...
		OBJECT(MODEL_BITS_WARP_PIPE , -1061, 102, -4874, 0, 0, 0, 0x000B0000, bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE , -802, 102, -4874, 0, 0, 0, 0x00090000, bhvWarpPipe),
	...
	AREA(3, bob_area_3),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 15, 0, 99, 0, 0, 0, 0x00040000, bhvInstantActiveWarp),
