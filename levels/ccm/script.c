...
const LevelScript level_ccm_entry[] = {
	...
	AREA(4, ccm_area_4),
		...
		OBJECT(MODEL_HEART, -30, 94, 10871, 0, 0, 0, 370, bhvRecoveryHeart),
		OBJECT(MODEL_HEART, 270, 94, 10871, 0, 0, 0, 370, bhvRecoveryHeart),
		OBJECT(MODEL_HEART, -330, 94, 10871, 0, 0, 0, 370, bhvRecoveryHeart),
	...
	AREA(5, ccm_area_5),
		...
		WARP_NODE(0xF1, LEVEL_CCM, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		INSTANT_WARP(0x00, 0x05, 0, 0, 0),
		OBJECT(MODEL_GOOMBA, -43, 0, -10407, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 139, 0, -10020, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 80, 0, -10772, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -91, 0, -11153, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 22, 0, -11493, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 185, 0, -11161, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -116, 0, -9533, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 61, 0, -8781, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 409, 0, -9096, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 136, 0, -9473, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -79, 0, -8815, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -272, 0, -8170, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -137, 0, -9012, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -301, 0, -9610, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -397, 0, -10587, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -449, 0, -11407, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -235, 0, -11840, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -19, 0, -11892, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 258, 0, -11598, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 347, 0, -11357, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 343, 0, -10789, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 421, 0, -9906, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 352, 0, -9570, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 300, 0, -8131, 0, 0, 0, 0x00000000, bhvGoomba),
