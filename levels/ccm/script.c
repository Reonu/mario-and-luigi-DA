...
const LevelScript level_ccm_entry[] = {
	...
	AREA(5, ccm_area_5),
		...
		OBJECT(MODEL_BOWSER_BOMB, -285, 3430, 10878, 0, 0, 0, 2, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -297, 4449, 11908, 0, 0, 0, 2, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 341, 4890, 12323, 0, 0, 0, 4, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -296, 5349, 12755, 0, 0, 0, 2, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 335, 3978, 11465, 0, 0, 0, 4, bhvBowserBomb),
