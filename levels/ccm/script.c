...
const LevelScript level_ccm_entry[] = {
	...
	AREA(3, ccm_area_3),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 176, 129, -8868, 0, 0, 0, 0x00000000, bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, 453, -171, -8868, 0, 0, 0, 0x00000000, bhvBreakableBox),
		OBJECT(MODEL_FLYGUY, -166, -171, -4120, 0, 0, 0, 0x00000000, bhvFlyGuy),
		OBJECT(MODEL_FLYGUY, 1046, 1234, -3074, 0, 0, 0, 0x00000000, bhvFlyGuy),
