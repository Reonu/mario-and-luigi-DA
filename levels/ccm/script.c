...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, -171, -364, -3628, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -34, -169, -7868, 0, -1, 0, 0x00000000, bhvCoinFormation),
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_NONE, -33, 1698, -7312, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 132, 0, -9657, 0, 0, 0, 0x00000000, bhvCoinFormation),
	...
	AREA(3, ccm_area_3),
		...
		OBJECT(MODEL_YELLOW_COIN, 882, 1234, -3021, 0, 90, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -60, 1974, -2820, 0, 90, 0, 0x00000000, bhvYellowCoin),
		...
		OBJECT(MODEL_YELLOW_COIN, -50, 698, -3166, 0, 90, 0, 0x00000000, bhvYellowCoin),
	...
	AREA(5, ccm_area_5),
		...
		OBJECT(MODEL_BOWSER_BOMB, -385, 3430, 10878, 0, 0, 0, 2, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -397, 4449, 11908, 0, 0, 0, 2, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 441, 4890, 12323, 0, 0, 0, 4, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -396, 5349, 12755, 0, 0, 0, 2, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 435, 3978, 11465, 0, 0, 0, 4, bhvBowserBomb),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -110, 2943, 9908, 0, 90, 0, 0x00120000, bhvMessagePanel),
		...
		OBJECT(MODEL_NONE, 0, 0, 10995, 0, 0, 0, 0x00000000, bhvCoinFormation),
	...
	AREA(6, ccm_area_6),
		...
		OBJECT(MODEL_BOWSER_BOMB, 0, 854, 7707, 0, 0, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 0, 854, 7212, 0, 0, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 0, 1450, 7212, 0, 0, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 0, 854, 6708, 0, 0, 0, 0x00000000, bhvBowserBomb),
		...
		OBJECT(MODEL_YELLOW_COIN, -44, 1124, 3127, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -34, 1624, 2594, 0, 0, 0, 0x00000000, bhvYellowCoin),
	...
	AREA(7, ccm_area_7),
		...
		INSTANT_WARP(0x00, 0x07, -6000, 0, 0),
		WARP_NODE(0xF0, LEVEL_BOB, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_FLYGUY, 421, 3705, -3111, 0, 0, 0, 0x00000000, bhvFlyGuy),
		OBJECT(MODEL_FLYGUY, -422, 2701, -3716, 0, 0, 0, 0x00000000, bhvFlyGuy),
		OBJECT(MODEL_FLYGUY, 633, 1803, -4421, 0, 0, 0, 0x00000000, bhvFlyGuy),
		OBJECT(MODEL_GOOMBA, -121, 1396, -4718, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -412, 2104, -4116, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, 537, 3093, -3431, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -402, 3398, -3250, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_MR_BLIZZARD, 680, 458, -6212, 0, 0, 0, 0x00000000, bhvMrBlizzard),
		OBJECT(MODEL_MR_BLIZZARD, 711, 202, -6896, 0, 0, 0, 0x00000000, bhvMrBlizzard),
		OBJECT(MODEL_MR_BLIZZARD, -673, 467, -6156, 0, 0, 0, 0x00000000, bhvMrBlizzard),
		OBJECT(MODEL_MR_BLIZZARD, -642, 189, -6899, 0, 0, 0, 0x00000000, bhvMrBlizzard),
		...
		ROOMS(ccm_area_7_collision_rooms),
