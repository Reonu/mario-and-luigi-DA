COURSE_ACTS(COURSE_BOB, _(" 1 TOAD VILLAGE"),
       _("GO TO THE SNOWY MOUNTAINS")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 SNOWY MOUNTAINS"),
       _("GET THE STAR!")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
